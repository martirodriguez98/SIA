...
def get_single_point(first_parent: Individual, second_parent: Individual, param: Param) -> Tuple[
    Individual, Individual]:
    return aux_get_multiple_point(first_parent, second_parent, 1)


def get_multiple_point(first_parent: Individual, second_parent: Individual, param: Param) -> Tuple[
    Individual, Individual]:
    return aux_get_multiple_point(first_parent, second_parent, param['points_q'])


def aux_get_multiple_point(first_parent: Individual, second_parent: Individual, points_q: int) -> Tuple[
    Individual, Individual]:
